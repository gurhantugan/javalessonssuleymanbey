...
public class Arrays02 {
    ...
    public static void main(String[] args) {
        ...
        String s1[] = {"A", "T", "C"};
        System.out.println("Before sorting s1: " + Arrays.toString(s1));
        
        //If you use "String s2[] = s1;" instead of using "copyOf()" method
        //everytime you will get "Array elements are sorted" message. 
       // Because when you sort s1, s2 will be sorted 
        //as well. 
        ...
        Arrays.sort(s1);
        System.out.println("After sorting s1: " + Arrays.toString(s1));
