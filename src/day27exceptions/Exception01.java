...
//s5.substring(12) ==>we do not have such a string.It does not exist.
// we will carry the problem inside the method by using if method inside the try body.
// it is different from other problems
// the problem was not inside the method
