	...
	public static void main(String[] args) {
		...
		*/
		...
		// How to assign value for specific indexes?
			...
			// if you use toString() for multidimensional arrays, you can not see the elements
			// you will see the references on the console.
		System.out.println(Arrays.deepToString(arr2));
		
		// Question-1) Find the sum of all elements in an integer 2 dimensional array
